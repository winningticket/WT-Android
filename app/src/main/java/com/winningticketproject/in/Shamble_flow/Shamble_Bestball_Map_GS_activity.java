...
public class Shamble_Bestball_Map_GS_activity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView tv_fairway_hit,tv_green_regu,tv_putts,tv_selected_user,tv_gs_info;
    ...
    String best_shamble_notes_values="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(game_name.equals("shamble")){
            ...
            info_gross_score.setText("During a scramble, all team members have the \n ability to edit the team score from their device");
        }

////        all_players = findViewById(R.id.all_players);
////        all_players.setTypeface(medium);
//
//        if (Share_it.get_auth_token("Game_type").equals("shamble") || game_name.equals("bestball") || game_name.equals("scramble")){
...
//        }
        ...
        tvholes.setText("Hole "+hole_data+" - "+"Par "+par_data);
        ...
        lv_player_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                final Animation myAnim = AnimationUtils.loadAnimation(Shamble_Bestball_Map_GS_activity.this, R.anim.button_zoom);
            ...
            case R.id.save_grsoss_info :
                ...
                if (backposition==-1){
                    ...
                    try {
                        ...
                        com.winningticketproject.in.AppInfo.ProgressDialog.getInstance().showProgress(Shamble_Bestball_Map_GS_activity.this);
                        ...
                        netscorecalculation.put("notes", best_shamble_notes_values);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (response.getString("status").equals("Success")){
                                best_shamble_notes_values="";
                                btn_add_note.setVisibility(View.VISIBLE);
                                et_layout.setVisibility(View.GONE);
                            }
                            Toast.makeText(Shamble_Bestball_Map_GS_activity.this,response.getString("message"),Toast.LENGTH_LONG).show();
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (networkResponse != null && networkResponse.statusCode == HttpStatus.SC_UNAUTHORIZED) {
                            ...
                            if (error.networkResponse.statusCode == 401) {
                                Alert_Dailog.showNetworkAlert(Shamble_Bestball_Map_GS_activity.this);
                            } else {
                                Toast.makeText(Shamble_Bestball_Map_GS_activity.this, "Some thing went wrong", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(Shamble_Bestball_Map_GS_activity.this, "Some thing went wrong", Toast.LENGTH_SHORT).show();
                        }
        ...
        btn_save_notes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (et_add_note.getText().toString().isEmpty()){
                    ...
                    best_shamble_notes_values=et_add_note.getText().toString();
                    alertDialog_2.dismiss();
    ...
    public void alertdailogbox(final String value){
        ...
        public void methodtocallnetscoreApi(JSONObject data) {
            ...
            if (Share_it.get_auth_token("play_type").equals("free") || Share_it.get_auth_token("play_type").equals("paid")){
                ...
                url_value = "hole_info/gross_score/" +Share_it.get_auth_token("event_id")+"/"+player_id;
            }
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                if (response.getString("status").equals("Success")) {
                                    ...
                                    View_course_map.hole_number_from_all_corses = Integer.parseInt(hole_data);
                                    finish();
        ...
        private void method_to_show_player_GS() {
            ...
            if (Integer.parseInt(par_data)==3){
        ...
        par_position = new HashMap<String, String>();
            ...
            Eagle = Integer.parseInt(par_data)-2 +"";
        Birdie = Integer.parseInt(par_data)-1 +"";
        par_postion = Integer.parseInt(par_data)-0 +"";
        Bogey = Integer.parseInt(par_data)+1 +"";
        double_Bogey = Integer.parseInt(par_data)+2 +"";
        ...
        gridview.setAdapter(new Shamble_GS(Shamble_Bestball_Map_GS_activity.this,score,par_position));
...
//
        ...
        gross_score_poup_gridview.setAdapter(new GridAdapter2(Shamble_Bestball_Map_GS_activity.this, score2, par_position));
    ...
    public void method_to_load_api(JSONObject objects) {
        try {
            com.winningticketproject.in.AppInfo.ProgressDialog.getInstance().showProgress(Shamble_Bestball_Map_GS_activity.this);
            JsonObjectRequest myRequest = new JsonObjectRequest(Request.Method.POST, Splash_screen.url + "hole_info/view_score/event/"+Share_it.get_auth_token("event_id"), objects,
                    new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                System.out.println("-----------map reponse------"+response);
                                com.winningticketproject.in.AppInfo.ProgressDialog.getInstance().hideProgress();

                                if (response.getString("user_type").equals("premium")) {
                                    best_shamble_notes_values = response.getString("notes");
                                    if (best_shamble_notes_values.equals("null") || best_shamble_notes_values.equals(null)) {
                                        best_shamble_notes_values="";
                                        btn_add_note.setVisibility(View.VISIBLE);
                                    } else {
...
//                linearLayout.addView(addButton());
    ...
    public void method_to_api_gross_score_api() {

        String url_value="api/v2/hole_info/select-course-info/" + get_auth_token("event_id");
        try {
                            ...
                            try {
                                ...
                                if (response.getString("status").equals("Success")) {
                                    ...
                                    for (int i = 0; i < hole_info.length(); i++) {
                                        ...
                                        No_of_player.put(i+1+"",shamble_score_cards);
                                    }

                                    ProgressDialog.getInstance().hideProgress();

                                    player_in = No_of_player.get(hole_data);

                                    lv_player_list.setAdapter(new Player_list_adapter(Shamble_Bestball_Map_GS_activity.this,player_in));
                                    ...
                                    Toast.makeText(Shamble_Bestball_Map_GS_activity.this, response.getString("message"), Toast.LENGTH_SHORT).show();
                                }
