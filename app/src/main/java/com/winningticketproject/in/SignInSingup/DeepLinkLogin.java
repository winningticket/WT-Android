...
public class DeepLinkLogin extends AppCompatActivity implements View.OnClickListener {
    Button btn_login;
                        ...
                        try {
                            if (response.getString("status").equals("Success")){
                                ...
                                if (switch_Button.isChecked()){
                                    ...
                                    Share_it.remove_key("username");
                                }

                                Share_it.savestring("user_player_type", "user");
...
//                                    Intent in = new Intent(getApplicationContext(), NewLive_AuctionItem.class);
//                                    in.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                                    in.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                                    in.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK );
//                                    startActivity(in);

                                    DeepLinkLogin.this.finish();
//                                    DeepLinkLogin.super.onBackPressed();
    ...
    public  void forgot_popup(){
        ...
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(DeepLinkLogin.this, R.style.CustomDialogTheme);
        LayoutInflater inflater = (LayoutInflater) DeepLinkLogin.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                ...
                if(email_text.getText().toString().isEmpty()) {
                    ...
                    try {
                        if (!isNetworkAvailable()) {
                            ...
                            hiddenInputMethod();
                            ProgressDialog.getInstance().showProgress(DeepLinkLogin.this);
                            JSONObject user = new JSONObject();
                            JSONObject parameter = new JSONObject();
