...
public class Stable_ford_Leaderboard extends AppCompatActivity implements View.OnClickListener {
    ...
    Stable_ford_leader_adapter adapterz;
...
//    String Server_url = "ws://192.168.1.141:3000/cable";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stable_ford__leaderboard);
        ...
        if (!isNetworkAvailable()) {
           Toast.makeText(Stable_ford_Leaderboard.this,"No Internet Available",Toast.LENGTH_LONG).show();
        }
        else
        {
            devider=0;
...
//
                                    ...
                                    public void onErrorResponse(VolleyError error) {
                                        ...
                                        if (networkResponse != null && networkResponse.statusCode == HttpStatus.SC_UNAUTHORIZED) {
                                            ...
                                            if (error.networkResponse.statusCode == 401) {
                                                ...
                                                Alert_Dailog.showNetworkAlert(Stable_ford_Leaderboard.this);
                                            } else {

                                                if (pd.isShowing()) {
                                                    pd.dismiss();
                                                }
                                                Toast.makeText(Stable_ford_Leaderboard.this, "Some thing went wrong", Toast.LENGTH_SHORT).show();
    ...
    public void methodforscorecard() {
        ...
        try {
            pd = new ProgressDialog(Stable_ford_Leaderboard.this);
                    ...
                    new com.android.volley.Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                adapterz = new Stable_ford_leader_adapter(Stable_ford_Leaderboard.this, alleventlist_List,childArrayList);
    ...
    public void Super_ticket_poup() {
        ...
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(Stable_ford_Leaderboard.this, R.style.CustomDialogTheme);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_leader_board:
                in = new Intent(Stable_ford_Leaderboard.this, StableFord_Score_Card.class);
            ...
            case R.id.btn_gps:
                if (home.equals("home")){
                    in = new Intent(Stable_ford_Leaderboard.this , View_course_map.class);
                    savestring("id",event_id);
                    in.putExtra("home","home");
                    startActivity(in);
                    finish();
    ...
    public class Stable_ford_leader_adapter extends BaseExpandableListAdapter {
        ...
        public Stable_ford_leader_adapter(Context context, List<parent_getter_setter> headerArray,
        ...
        public View getChildView(int groupPosition, final int childPosition,
            ...
            if (convertView == null) {
                convertView = infalInflater.inflate(R.layout.custorm_stable_ford, null);
            }
...
//
            ...
            roq_iii_2.setTextColor(Color.BLACK);
            ...
            roq_iii_3.setTextColor(Color.BLACK);
            ...
            roq_iii_4.setTextColor(Color.BLACK);
            ...
            roq_iii_5.setTextColor(Color.BLACK);
            ...
            roq_iii_6.setTextColor(Color.BLACK);
            ...
            roq_iii_7.setTextColor(Color.BLACK);
            ...
            roq_iii_8.setTextColor(Color.BLACK);
            ...
            roq_iii_9.setTextColor(Color.BLACK);
            ...
            roq_iii_10.setTextColor(Color.BLACK);
            ...
            row_2_roq_iii_2.setTextColor(Color.BLACK);
            ...
            row_2_roq_iii_3.setTextColor(Color.BLACK);
            ...
            row_2_roq_iii_4.setTextColor(Color.BLACK);
            ...
            row_2_roq_iii_5.setTextColor(Color.BLACK);
            ...
            row_2_roq_iii_6.setTextColor(Color.BLACK);
            ...
            row_2_roq_iii_7.setTextColor(Color.BLACK);
            ...
            row_2_roq_iii_8.setTextColor(Color.BLACK);
            ...
            row_2_roq_iii_9.setTextColor(Color.BLACK);
            ...
            row_2_roq_iii_10.setTextColor(Color.BLACK);
