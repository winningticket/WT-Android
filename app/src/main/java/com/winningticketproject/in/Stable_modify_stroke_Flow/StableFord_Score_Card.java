...
public class StableFord_Score_Card extends AppCompatActivity implements View.OnClickListener {
    View dialogview;
    ...
    TextView tvtotal_score, tvholes, tvdistance, tvgrassscore, tvnetscore, tvpar;
    ...
    Stable_For_ScorecardApater horizontalAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stable_ford__score__card);
    ...
    private void Team_edit_popup() {
        ...
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(StableFord_Score_Card.this, R.style.CustomCastTheme);
        ...
        continue_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!isNetworkAvailable()) {
                    Toast.makeText(StableFord_Score_Card.this,"No Internet Available",Toast.LENGTH_LONG).show();
                }
                else
                {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            if (response.getString("status").equals("Success")){
                                ...
                                Toast.makeText(StableFord_Score_Card.this,""+response.getString("message"),Toast.LENGTH_LONG).show();
                            }
                        } catch (Exception e) {
                            //nothing
                        }
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (networkResponse != null && networkResponse.statusCode == HttpStatus.SC_UNAUTHORIZED) {
                            ...
                            if (error.networkResponse.statusCode == 401) {
                                Alert_Dailog.showNetworkAlert(StableFord_Score_Card.this);
                            } else {
                                Toast.makeText(StableFord_Score_Card.this, "Some thing went wrong", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(StableFord_Score_Card.this, "Some thing went wrong", Toast.LENGTH_SHORT).show();
    ...
    public void methodforscorecard() {
        ...
        try {
            ...
            recycler_view = findViewById(R.id.stable_ford_recycler_view);
            ...
            JsonObjectRequest myRequest_handicap = new JsonObjectRequest(
                    Request.Method.POST, Splash_screen.imageurl
                    +url_value , params,
                    new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                if (response.getString("status").equals("Success")) {
                                    try {
                                        ...
                                        tv_to_par_values.setText(Html.fromHtml("<b><big>"+to_par+"</big></b>"+"<br> SF"));
                                    ...
                                    for (int i = 0; i < hole_info.length(); i++) {
                                        ...
                                        data6.put(hole_postion, hole_object.getString("sf_msf_score"));
                                    }
                                    ...
                                    if (data1.size()>10){
                                        ...
                                        hole_postionss.add(hole_info.length() + 2 + "");
                                        ...
                                        hole_postionss.add(hole_info.length() + 3 + "");
                                    ...
                                    horizontalAdapter = new Stable_For_ScorecardApater(data1, data2, data3, data4, data5,data6,hole_postionss, StableFord_Score_Card.this);
                                    LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(StableFord_Score_Card.this, LinearLayoutManager.VERTICAL, false);
                                    ...
                                    Toast.makeText(StableFord_Score_Card.this, response.getString("message"), Toast.LENGTH_SHORT).show();
                                }
        ...
        switch (view.getId()){
            case R.id.btn_leader_board:
                if (!Location_Services.game_name.equals("Course")) {
                    ...
                    Intent in1 = new Intent(StableFord_Score_Card.this, Stable_ford_Leaderboard.class);
                    startActivity(in1);
                    finish();
            ...
            case R.id.iv_auction:
                in=new Intent(StableFord_Score_Card.this, NewLive_Auction.class);
                savestring("id",event_id);
                startActivity(in);
                break;

            case R.id.iv_leader_board:
                in = new Intent(this, Stable_ford_Leaderboard.class);
            ...
            case R.id.btn_gps:
                if(home.equals("home")){
                    in = new Intent(StableFord_Score_Card.this , View_course_map.class);
    ...
    public void Super_ticket_poup() {
        ...
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(StableFord_Score_Card.this, R.style.CustomDialogTheme);
    ...
    public class Stable_For_ScorecardApater extends RecyclerView.Adapter<Stable_For_ScorecardApater.MyViewHolder> {
        ...
        public Stable_For_ScorecardApater(Map<String, String> data2, Map<String, String> data3, Map<String, String> data4, Map<String, String> data5, Map<String, String> data6, Map<String,String> data7, ArrayList<String> postion_list, Context context) {
            this.data2 = data2;
            this.data3 = data3;
            this.data4 = data4;
            this.data5 = data5;
        ...
        @Override
        public Stable_For_ScorecardApater.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.custome_stable_score_card, parent, false);
            return new Stable_For_ScorecardApater.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(final Stable_For_ScorecardApater.MyViewHolder holder, final int position) {
...
//            }
            ...
            if (!data7.get(holder.postiondata).equals(null) || !data7.get(holder.postiondata).equals("null") || !data7.get(holder.postiondata).equals("")) {

                int total_remaining = Integer.parseInt(data7.get(holder.postiondata));

                System.out.println("-----------------"+total_remaining);
                ...
                public void onClick(View view) {
                    ...
                    if (data1.size()==10){
                        if (position == data3.size() - 1 ){
                            ...
                            Intent in = new Intent(StableFord_Score_Card.this, AddScoresToScorecard.class);
