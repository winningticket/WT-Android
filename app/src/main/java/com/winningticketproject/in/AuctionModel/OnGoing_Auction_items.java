...
public class OnGoing_Auction_items extends Fragment implements View.OnClickListener{
    ...
    String  auth_token= "",id="",url,selected_item;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        method_to_ongoing_Auction_api(Splash_screen.imageurl + "api/v2/auction/ongoing-list/"+id+"?sort_by="+"item_number",2);

        System.out.println("------------audct----------------"+Splash_screen.imageurl + "api/v2/auction/ongoing-list/"+id+"?sort_by="+"item_number");
    ...
    private void method_to_ongoing_Auction_api(String selected_item_type , int i) {
        auction_list_data.clear();
        if (i==1){
            if (!pd.isShowing()) {
                pd.show();
        ...
        JsonObjectRequest myRequest = new JsonObjectRequest(Request.Method.GET, selected_item_type,null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        {
                            pd.hide();
                            System.out.println("------response_ongoing------"+response);
                            ...
                            if (auction_items.length() == 0) {
                                ...
                                for (int k = 0; k < auction_items.length(); k++) {
                                    ...
                                    Liveauction1 allevents = new Liveauction1(getContext(),auction_list_data);
...
//                                                        try {
//                                                            loadingMore = true;
//                                                            method_to_ongoing_Auction_api(Splash_screen.imageurl + "api/v2/auction/ongoing-list/"+id+"/?page="+ current_page+"?sort_by="+selected_item,2);
//                                                        } catch (Exception e) {
//                                                        }
//                                                    }
//                                                }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (networkResponse != null && networkResponse.statusCode == HttpStatus.SC_UNAUTHORIZED) {
                            ...
                            pd.dismiss();
//                            Toast.makeText(getContext(), "Some thing went wrong", Toast.LENGTH_SHORT).show();
//                         Alert_Dailog.showNetworkAlert1(getActivity());
                        }
                    }
                }) {
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.Item_Number:
                ...
                pd.show();
                auction_list_data.clear();
                url = Splash_screen.imageurl +"api/v2/auction/ongoing-list/"+id;
                selected_item = "item_number";
                method_to_ongoing_Auction_api(url+"?sort_by="+selected_item,1);
                Lowest_Price.setBackground(getResources().getDrawable(R.drawable.background_dialog));
                Highest_Price.setBackground(getResources().getDrawable(R.drawable.background_dialog));
                Time_End_Show.setBackground(getResources().getDrawable(R.drawable.background_dialog));
                break;
...
public static class Liveauction1  extends BaseAdapter {
    ...
    Liveauction1(Context context, ArrayList<Auction_List_Data> auction_list_data) {
        super();
    ...
    public class ViewHolder {
        TextView live_auction_title, item_number, tv_item_date_time, live_auction_bid_amount, live_auction_buy_amount;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.fragment_ongoing_auction, null);
        ...
        date1 = newDateStr.replace("am", "AM").replace("pm", "PM") + " " + auction_list_data.get(position).getEvent_short_time_zone();
        ...
        long timer = ConvertDate(auction_list_data.get(position).getAuctionenddate()).getTime();
        Date today = new Date();
...
//        }.start();
        ...
        Picasso.with(context).load(auction_list_data.get(position).getAuctionimage()).error(R.drawable.auto_image).placeholder(R.drawable.auto_image)
        ...
        if (currentbid.equals(null) || currentbid.equals("null") || currentbid.equals(" ")) {
            ...
            String bid_amount_values = "<font color='#ffffff'><b><big>$ " + s + ".00</big></b>" + " Bid</font>";
