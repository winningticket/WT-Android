...
public class SkuDetails implements Parcelable
{
    ...
    public final String subscriptionOrderID;
    ...
    public SkuDetails(JSONObject source) throws JSONException
    {
        ...
        subscriptionOrderID = source.optString(Constants.RESPONSE_ORDER_ID);
    ...
    {
        dest.writeString(this.subscriptionOrderID);
    ...
    {
        this.subscriptionOrderID = in.readString();
